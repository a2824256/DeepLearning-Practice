...
def draw(x_1, x_2, x_3):
    ...
    ax.scatter(x_1, x_2, (5 * x_1 + 3 * x_2 - 1) ** 2, label="y_1_minimum", color="green")
    ax.scatter(x_1, x_3, (-3 * x_1 - 4 * x_3 + 1) ** 2, label="y_2_minimum", color="red")
    ax.scatter(x_1, x_2, x_3, label="fx_minimum", color="orange")
...
if __name__ == '__main__':
    ...
    fx = tf.add(tf.square(y_1), tf.square(y_2))
    train = tf.train.GradientDescentOptimizer(0.01).minimize(fx)
    ...
    minimum = tf.Variable(0, dtype=tf.float32)
